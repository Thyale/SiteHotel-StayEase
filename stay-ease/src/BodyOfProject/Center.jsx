function Center(){
    return(
        <section className="bg-[url('./ImgCapaResort.jpg')] bg-no-repeat bg-cover bg-center text-white dark:text-gray-900 text-xl py-40 flex items-center justify-center">
            <div className="flex flex-col gap-7">
                ...
                <div className="flex flex-row gap-5 w-11/12 m-auto cel:flex-col items-center justify-around">
                    <div className="bg-white dark:bg-gray-900 text-gray-400 flex flex-row itens-center gap-5 p-3 rounded w-11/12 justify-center">
                       <input className="border-transparent outline-none w-full text-center  dark:bg-gray-900" type="text" name="Estado" id="estado" placeholder="Escolha o estado" />
                       <span class="material-symbols-outlined">stat_minus_1</span>
                    </div>
                    <div className="bg-white  dark:bg-gray-900 text-gray-400 flex flex-row itens-center gap-5 p-3 rounded w-11/12 justify-center">
                       <input className="border-transparent outline-none w-full text-center  dark:bg-gray-900" type="text" name="cidade" id="cidade" placeholder="Escolha a cidade" />
                       <span class="material-symbols-outlined">stat_minus_1</span>
                    </div>
